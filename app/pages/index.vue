			...
			<div class="max-w-6xl w-full">
				<div class="grid lg:grid-cols-2 gap-16 items-center">
					...
					<div class="flex justify-center">
						<div class="w-full max-w-md">
							<div class="bg-white rounded-lg border border-gray-200 p-8">
								<div class="text-center mb-8">
									<div class="w-80 h-32 bg-white rounded-lg flex items-center justify-center mx-auto mb-6">
										<NuxtImg
											src="/openid-logo.svg"
											alt="OpenID"
											width="288"
                      ...
                      <span class="w-4 h-4 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-semibold mr-2">
                        1
                      </span>
                      ...
                      <span class="w-4 h-4 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-semibold mr-2">
                        3
										...
										<div class="flex items-center text-xs text-gray-600">
                      <span class="w-4 h-4 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-xs font-semibold mr-2">
                        ✓
                      </span>
